...
-- uso de predicados
-- operadores realacionaleas
--1) listar a todos los empleados ue ganan entre 2000 y 4000 $
select *
from empleados
...
-- liastar todos los empleados ue no ganan de  2000 y 4000
select *
from empleados
where salario  not between 2000 and 4000;

-- listar a los empleados que tienen el valor null en apellido
select *
from empleados
where apellidos is not null;

INSERT INTO empleados (nroemp,nombres,salario,nrodpto,cargo)VALUES(18,'Hugo',5000,100,'Vendedor');

--  listar a todos los empleados que empiecenn on la letra j
select *
from empleados
where nombres like 'J%';

-- listar a los empleados cuyos nombres en la penultima letra sea a
select *
from empleados
where nombres like '%a_';

-- listar a los conductores  cuyos apellidos no empiecen con la letra comprendida entre B y R
select*
from empleados
where apellidos like '[^B-R]%';

--

-- listar a todos los epleados que no tienen el valor nulo en el apellido
select *
from empleados
where apellidos is null;
--PREDICADOS IN ALL ANY SOME
-- listar a todos los empleados que tengan el salario igual al minimo de los departeamentos
select *
 from empleados
 where salario in (
 ...
 --11
SELECT SUM(salario) As SalarioTotalEmpleadosBs
FROM empleados
WHERE EXISTS (
SELECT*
FROM empleados
...
--Listar a todos los empleados que tienen salario menor a alguno de los empleados quetiene cargo asistente
SELECT *
FROM empleados
WHERE salario < ANY
(
